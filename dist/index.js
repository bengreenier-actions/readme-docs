...
const semver_2 = __nccwpck_require__(4107);
const True = 'true';
function processRequest(input) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        const versions = (yield (0, node_fetch_cjs_1.default)(`https://dash.readme.com/api/v1/version`, {
            method: 'GET',
            headers: {
        ...
        const orderedVersions = versions
            .map(v => (Object.assign(Object.assign({}, v), { semver: (0, semver_1.parse)(v.version_clean) })))
            .filter(v => v.semver !== null)
            .sort((a, b) => (0, semver_1.rcompare)(a.semver, b.semver));
        core.info(`📃 Found versions: ${orderedVersions.map(v => v.version).join(', ')}`);
        ...
        const titlePrefix = (_b = `${input.titlePrefix} `) !== null && _b !== void 0 ? _b : '';
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.determineVersionBase = void 0;
const semver_1 = __nccwpck_require__(1383);
/**
 ...
 */
function determineVersionBase(target, existing) {
    ...
    // ascending order
    const ordered = existing.sort(semver_1.compare);
    ...
    for (let i = 0; i < ordered.length - 1; i++) {
        ...
        if ((0, semver_1.gte)(target, current)) {
            // if we're: next == null || next > target
            if (!next || (0, semver_1.lt)(target, next)) {
                // return current
                return current;
            }
        }
...
exports.determineVersionBase = determineVersionBase;
...
var _semver = _interopRequireDefault(__nccwpck_require__(1383));
